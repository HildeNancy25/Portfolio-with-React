    ...
    <>
        ...
        <div class="flex items-center justify-center gap-8 my-6 w-full  flex-wrap hover:border-l-2 hover:border-[#a82c7c]">
            <div className='flex md:flex-row sm:flex-col'>
                <div class="md:w-[550px] md:h-96 max-auto flex flex-wrap justify-center gap-3 roundes-2xl p-5">
                    <a href="https://hildenancy25.github.io/RockPaperScissors/">
                        <img src="rock.png" class="w-60"></img>
                    </a>
                    <a href="https://hildenancy25.github.io/AgeCalculator/">
                        <img src="ageCalc.png" class="w-60"></img>
                    </a>
                    <a href="https://hildenancy25.github.io/Dice-Roll-Simulator/">
                        <img src="dice.png" class="w-60"></img>
                    </a>
                    <a href="https://hildenancy25.github.io/emoji/">
                        <img src="emoji.png" class="w-60"></img>
                    </a>
                </div>
                <div class="md:w-[600px] md:h-96 max-auto roundes-2xl p-5">
                    <p class="text-gray-400 mb-2">JavaScript, CSS, HTML</p>
                    ...
                    <div class="bg-gray-300 w-56 h-3 rounded-full">
                        <div class="bg-[#a82c7c] w-48 h-3 rounded-full"> </div>
                    </div>
                    <p>CSS:</p>
                    <div class="bg-gray-300 w-56 h-3 rounded-full">
                        <div class="bg-[#a82c7c] w-8 h-3 rounded-full"> </div>
                    </div>
                    <p>HTML:</p>
                    <div class="bg-gray-300 w-56 h-3 rounded-full">
                        <div class="bg-[#a82c7c] w-14 h-3 rounded-full"> </div>
                    </div>
            ...
            <div className='flex md:flex-row sm:flex-col-reverse'>
                <div class="md:w-[600px] md:h-96 max-auto roundes-2xl p-5">
                    ...
                    <a href="file:///C:/Users/HP/Downloads/FILINI%20Wireframe.pdf">
                        <button class="px-3 py-1 mt-4 border rounded-full border-[#a82c7c] hover:bg-[#a82c7c]
                            hover:text-black">
                            View This Work
                        </button>
                    </a>
                ...
                <div class="md:w-[550px] md:h-96 max-auto flex flex-wrap justify-center gap-3 roundes-2xl p-5">
                    <img src="country.png" class=""></img>
                </div>
            </div>
            
            <div className='flex md:flex-row sm:flex-col'>
                <div class="md:w-[550px] md:h-96 max-auto flex flex-wrap justify-center gap-3 roundes-2xl p-5">
                    <img src="./proj1.png" class="w-96"></img>
                </div>
                <div class="md:w-[600px] md:h-96 max-auto roundes-2xl p-5">
            ...
            <div className='flex md:flex-row sm:flex-col-reverse'>
                ...
                <div class="md:w-[550px] md:h-96 max-auto flex flex-wrap justify-center gap-3 roundes-2xl p-5">
                    <img src="Proj3.png" class="w-96"></img>
                </div>
            </div>
        </div>
